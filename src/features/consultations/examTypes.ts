import { Exame, EXAME_STATUS, type ExameCategoria, type ExameStatus } from '../../models/Exame'
...
export const newExam = (nome: string, categoria: ExameCategoria): ExamDraft => ({
  ...
  status: 'solicitado', resultado: '', interpretacao: '',
})
...
export function examToDraft(exam: Exame): ExamDraft {
  return { key: String(exam.id), nome: exam.nomeExame, categoria: exam.categoria,
