...
export function ComplementaryExamsStep({ exams, onChange, onBack, onNext }: { exams: ExamDraft[]; onChange: (exams: ExamDraft[]) => void; onBack: () => void; onNext: () => void }) {
  ...
  return <section className="consultation-panel content-card complementary-exams-step"><h2>4. Exames complementares</h2><p>Selecione os exames solicitados neste atendimento. Os resultados podem ser registrados posteriormente no prontuário.</p>
