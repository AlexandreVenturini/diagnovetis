import { Exame, type ExameCategoria, type ExameStatus } from '../../models/Exame'
...
export function exameToRow(exam: Exame) {
  return {
    ...
    status: exam.status, resultado: exam.resultado, interpretacao_clinica: exam.interpretacao,
  }
}
